        ...
        >
            ...
            <div className=" bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 rounded-2xl shadow-2xl border border-white/20 dark:border-slate-600/30">
                ...
                >
                    ...
                    <div className="ml-12 inline-flex items-center space-x-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50 rounded-full shadow-lg">
                            ...
                            <span className="text-[10px] font-semibold text-blue-800 dark:text-blue-200 capitalize">
                ...
                <div className="p-3">
                    ...
                    <div className="text-center mb-4">
                        ...
                        {callState.status === 'connected' && !transferState.isTransferring && (
                            <div className="text-lg font-mono text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-slate-700 px-3 py-1 rounded-md shadow-inner">
                                {formatDuration(callDuration)}
                            </div>
